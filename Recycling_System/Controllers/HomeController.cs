...
namespace u19192802_HW04.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        //Collects input from nonrenewable views stores them in variables which transfer parameters to the methods being called
        ...
        {
            int id = 0;
            //id is generated at chronologically because a nonrenewable entry has a unique code or primary key
